...
- `Dashboard.jsx` implementa el Resumen operativo con selector de dia de mayo 2026, KPIs, tres tablas de verificacion para manana, tarde y noche, verificacion por puesto con turno programado, auxiliares programados diferenciados con etiqueta, alertas dinamicas, cobertura por campus y ultimas sustituciones.
