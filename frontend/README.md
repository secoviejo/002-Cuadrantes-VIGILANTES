...
- `Dashboard.jsx` permite generar informe diario, mensual o anual mediante vista previa imprimible. El informe diario muestra las verificaciones confirmadas de manana, tarde y noche con incidencias, descubiertos y notas.
