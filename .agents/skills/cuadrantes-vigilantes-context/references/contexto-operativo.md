...
| Resumen operativo | Implementado en React con API | Muestra selector de dia de mayo 2026, KPIs, alertas, ultimas sustituciones, cobertura por campus y tres tablas de verificacion para los turnos manana, tarde y noche. Incluye solo puestos con turno programado e identifica auxiliares con etiqueta propia. |
...
- 2026-05-17: Conectadas las verificaciones de cobertura al Cuadrante mensual. El backend devuelve `verificacionEstado` y `verificacionResumen` por turno, y el frontend muestra incidencias verificadas en amarillo parpadeante y descubiertos verificados en rojo parpadeante.
- 2026-05-17: Anadido selector de dia al Resumen operativo. El operador puede navegar por los dias de mayo 2026 con flechas o campo de fecha, y las tres tablas de verificacion y el informe diario usan la fecha seleccionada.
- 2026-05-17: Incorporados auxiliares programados al Resumen operativo y al Cuadrante mensual: OCA San Francisco en turnos de manana/tarde laborables y C.M.U. Pedro Cerbuna/Ramon Acin en noches laborables y cobertura completa de fin de semana. El resumen diario filtra puestos sin turno real en la fecha consultada, y los servicios a demanda siguen fuera del resumen automatico hasta que tengan turnos programados.
